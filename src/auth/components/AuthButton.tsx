...
export const AuthButton = ({ text }: Props) => {
  ...
  return (
    <button disabled={status === 'checking'}
      ...
      <svg role="status" className={`absolute right-0 top-5 md:top-6 mr-5 w-7 h-7 text-white animate-spin ${status !== 'checking' && 'hidden'}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
